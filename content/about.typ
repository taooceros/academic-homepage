...
I build systems that exploit the hardware potential via software. My current research focus are in scalable synchronization, high-performance networking, and abstraction over emerging heterogeneous hardware. My current focus is to derive a practical asynchronous manycore programming model that can efficiently utilize the hardware parallelism of modern and future manycore processors.
